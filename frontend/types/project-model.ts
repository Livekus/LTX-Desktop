...
export const generationParamsSchema = z.object({
  ...
  audioMaxDuration: z.number().optional(),
...
export const projectV2Schema = z.object({
  ...
  centerAudioPath: z.string().nullable().default(null),
  centerAudioStartTime: z.number().nonnegative().default(0),
  centerAudioEndTime: z.number().nonnegative().nullable().default(null),
  centerAudioContinuous: z.boolean().default(false),
  createdAt: z.number(),
  updatedAt: z.number(),
